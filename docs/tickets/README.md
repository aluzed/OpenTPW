...
| [T-007](T-007-vm-opcodes-rse.md) | 🟡 Feature | ⚠️ Partial | Ride VM: **97/106** — Batch A (43 pure) complete + most Batch B (objects/anim/`WAIT*`/sound/scream, limbo/cross-VM/**walk** pure-VM families, + the **light** subsystem); 9 left (heads, effects, motion) |
