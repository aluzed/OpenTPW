...
| [T-032](T-032-ride-engine.md) | 🟡 Feature | ⚠️ In progress | Ride engine: seam + lifecycle + keyframe anim + scream + boarding bridge, and now backs **104/106 VM opcodes** (lights, particles/.PLB, limbo, walk, heads) + **ride breakdown & a mechanic** that repairs them + **visible moving cars** for tour/go-kart/water/bumper rides (`RideVehicle`, occupancy-driven); authored track geometry + TOUR/BUMP car-object opcodes + walk-node visuals remain |
