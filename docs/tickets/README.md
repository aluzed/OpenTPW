...
| [T-007](T-007-vm-opcodes-rse.md) | 🟡 Feature | ⚠️ Partial | Ride VM: **91/106** — Batch A (43 pure) complete + most Batch B (objects/anim/`WAIT*`/sound/scream, limbo & cross-VM pure-VM families, + the **light** subsystem); 15 left (walk, heads, effects, motion) |
