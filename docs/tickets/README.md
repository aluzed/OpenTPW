...
- **Tests**: ✅ `dotnet test` → **0 failed, 1 passed, 6 inconclusive** on a clean Linux
...
| [T-006](T-006-gamepath-config.md) | 🟡 Low | ⚠️ Partial | Windows default `GamePath` + no portable override |
