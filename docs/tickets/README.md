...
| [T-007](T-007-vm-opcodes-rse.md) | 🟡 Feature | ⚠️ Partial | Ride VM: **101/106** — Batch A (43 pure) complete + nearly all Batch B (objects/anim/`WAIT*`/sound/scream, limbo/cross-VM/walk/**head** pure-VM families, + the **light** & **particle** (.PLB-driven) subsystems); 5 left (ADDOBJ_EXT, GETCUSTPTCLCODE, motion TURBO/TOUR/BUMP) |
