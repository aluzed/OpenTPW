...
| [T-007](T-007-vm-opcodes-rse.md) | 🟡 Feature | ⚠️ Partial | Ride VM: **99/106** — Batch A (43 pure) complete + most Batch B (objects/anim/`WAIT*`/sound/scream, limbo/cross-VM/walk pure-VM families, + the **light** & **particle** (.PLB-driven) subsystems); 7 left (heads, ADDOBJ_EXT, GETCUSTPTCLCODE, motion) |
