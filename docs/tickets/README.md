...
| [T-045](T-045-coaster-track-editor.md) | 🟡 Feature | ⚠️ Slice 1 | Coaster: station placeable/queues via catalog (done); track-piece RE + laying + generation + running cars remain (recon'd) |
