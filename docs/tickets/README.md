...
| [T-007](T-007-vm-opcodes-rse.md) | 🟡 Feature | ⚠️ Partial | Ride VM: **83/106** — Batch A (43 pure) complete + most Batch B (objects/anim/`WAIT*`/sound/scream + the **limbo family**, RE'd as pure-VM); 23 left (lights, walk, heads, cross-VM) |
