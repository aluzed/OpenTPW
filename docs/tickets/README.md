...
| [T-032](T-032-ride-engine.md) | 🟡 Feature | ⚠️ In progress | Ride engine: seam + lifecycle + keyframe anim + scream + boarding bridge, and now backs **104/106 VM opcodes** (lights, particles/.PLB, limbo, walk, heads) + **ride breakdown & a mechanic** that repairs them; coaster-car motion + walk-node visuals remain |
