...
| [T-045](T-045-coaster-track-editor.md) | 🟡 Feature | ⚠️ Slices 1–3a | Coaster: station placeable/queues + elevated track-laying tool with pylons + a shuttle train of real CrocCar.MD2 cars running the laid segments (done, verified); 3D curved generation + peep boarding/scream remain (slice 3b) |
