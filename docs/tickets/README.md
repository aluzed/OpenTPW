...
| [T-007](T-007-vm-opcodes-rse.md) | 🟡 Feature | ⚠️ Partial | Ride VM: **87/106** — Batch A (43 pure) complete + most Batch B (objects/anim/`WAIT*`/sound/scream + the **limbo** & **cross-VM** families, RE'd as pure-VM); 19 left (lights, walk, heads, effects) |
